...
+ ![image-20211127210031189](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127210031189.png)

  ![image-20211127210039331](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127210039331.png)
...
+ ![image-20211127210648787](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127210648787.png)
...
+ ![image-20211127210730163](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127210730163.png)
...
+ ![image-20211127210801983](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127210801983.png)
...
+ ![image-20211127212704613](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127212704613.png)
+ ![image-20211127212725044](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211127212725044.png)
...
+ ![image-20211128073153394](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073153394.png)

+ ![image-20211128073208103](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073208103.png)
  ...
  int main()
  {
      ...
      // int i = 0;
      // while (memcmp(&tr[ ++ i], &zero, sizeof(Node)))
      // {
      //     Node &t = tr[i];
      //     printf("l = %d, r = %d, sum = %d, lmax = %d, rmax = %d, tmax = %d\n", t.l, t.r, t.sum, t.lmax, t.rmax, t.tmax);
      // }
...
+ ![image-20211128073304551](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073304551.png)
...
+ ![image-20211128073350121](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073350121.png)

+ ![image-20211128073357722](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073357722.png)
...
+ ![image-20211128073438923](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073438923.png)
...
+ `set` 中的 `upper_bound` 函数返回指向首个*大于* `key` 的元素的迭代器， `lower_bound` 返回指向首个*不小于* `key` 的元素的迭代器。
  ...
  void insert(int &p, int key)
  {
      ...
      {
          insert(tr[p].l, key);
          if (tr[p].val < tr[tr[p].l].val) R(p);
      }
      else
      {
          insert(tr[p].r, key);
          if (tr[p].val < tr[tr[p].r].val) L(p);
      }
  }
  ...
  {
      if (!p) return -INF;
      else if (key < tr[p].key) return get_prev(tr[p].l, key);
  ...
  {
      if (!p) return INF;
      else if (key > tr[p].key) return get_next(tr[p].r, key);
  ...
  int main()
  {
      ...
      while (T -- )
      {
          ...
          else res += min(t - get_prev(root, t), get_next(root, t) - t);
          insert(root, t);
      }
...
+ ![image-20211128073654803](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073654803.png)
...
+ ![image-20211128073727902](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073727902.png)
...
+ ![image-20211128073801386](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073801386.png)
+ ![image-20211128073809002](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073809002.png)
...
+ ![image-20211128073835801](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073835801.png)
+ ![image-20211128073845199](https://raw.githubusercontent.com/smallzhong/new_new_picgo_picbed/main/image-20211128073845199.png)
