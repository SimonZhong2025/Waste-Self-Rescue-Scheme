...
+ ![image-20201121101157715](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121101157715.png)

+ 如果是一致代码段，那么 `CPL` 的权限可以比 `DPL` 的权限低，因为这是一个共享代码段。

+ 如果是非一致代码段（不共享），那么只有  `CPL == DPL` 才可以访问，即等级一样才能访问，否则无法访问。

  ![image-20201121101647694](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121101647694.png)
...
+ 总结
  ...
  ![image-20201121102126698](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121102126698.png)
...
+ 首先 `eq` 修改段属性
  ...
  ![image-20201121103402628](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121103402628.png)

+ `jmp 004b:0041840d`

  ![image-20201121103655335](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121103655335.png)

  ![image-20201121103736496](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121103736496.png)

+ 而如果将 `DPL` 改为0，即第五位从 `f` 改为 `9` ，则无法跳转，会跳到 `ntdll` 异常模块里面去。

  ![image-20201121105132969](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121105132969.png)

  ![image-20201121105005237](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121105005237.png)

+ 而如果 `DPL` 改为0，但改为一致代码段

  ![image-20201121105418295](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121105418295.png)

  ![image-20201121105521718](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121105521718.png)
...
+ 总结
  ...
  ![image-20201121105658034](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121105658034.png)

  

### 长调用和短调用

+ ![image-20201121112208005](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121112208005.png)
+ ![image-20201121112157705](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121112157705.png)
...
+ 陷阱门也不允许传参数
  ...
  ![image-20201121170338411](https://cdn.jsdelivr.net/gh/smallzhong/picgo-pic-bed/image-20201121170338411.png)
